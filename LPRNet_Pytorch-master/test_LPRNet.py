...
def get_parser():
    ...
    parser.add_argument('--num_workers', default=3, type=int, help='Number of workers used in dataloading')
    parser.add_argument('--cuda', default=False, action='store_true', help='Use cuda to train model')
    parser.add_argument('--no_cuda', dest='cuda', action='store_false', help='Disable CUDA')
